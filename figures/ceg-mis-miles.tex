...
\pgfsetcolor{black}
  ...
  % Edge: w_{5} -> w_{27}
  \pgfsetcolor{black}
  \draw [->] [dashed] (291.11bp,518.11bp) .. controls (323.8bp,518.73bp) and (394.59bp,518.06bp)  .. (452.0bp,503.52bp) .. controls (461.79bp,501.04bp) and (472.03bp,496.92bp)  .. (489.98bp,488.38bp);
  \definecolor{strokecol}{rgb}{0.0,0.0,0.0};
  \pgfsetstrokecolor{strokecol}
  ...
  % Edge: w_{7} -> w_{27}
  \pgfsetcolor{black}
  \draw [->] [dashed] (285.68bp,374.79bp) .. controls (295.99bp,384.94bp) and (311.36bp,398.66bp)  .. (327.0bp,407.52bp) .. controls (360.87bp,426.71bp) and (375.71bp,417.09bp)  .. (410.0bp,435.52bp) .. controls (427.85bp,445.12bp) and (427.84bp,454.51bp)  .. (446.0bp,463.52bp) .. controls (455.99bp,468.48bp) and (467.71bp,472.05bp)  .. (488.0bp,476.67bp);
  \definecolor{strokecol}{rgb}{0.0,0.0,0.0};
  \pgfsetstrokecolor{strokecol}
  ...
  % Edge: w_{9} -> w_{47}
  \pgfsetcolor{black}
  \draw [->] [dashed] (291.38bp,187.8bp) .. controls (318.75bp,187.49bp) and (371.14bp,189.84bp)  .. (410.0bp,209.52bp) .. controls (412.35bp,210.71bp) and (458.43bp,257.25bp)  .. (493.08bp,292.39bp);
  \definecolor{strokecol}{rgb}{0.0,0.0,0.0};
  \pgfsetstrokecolor{strokecol}
  ...
  % Edge: w_{16} -> w_{27}
  \pgfsetcolor{black}
  \draw [->] [dashed] (400.45bp,383.49bp) .. controls (409.88bp,400.21bp) and (426.41bp,426.5bp)  .. (446.0bp,444.52bp) .. controls (456.12bp,453.83bp) and (469.14bp,461.79bp)  .. (489.46bp,472.29bp);
  \definecolor{strokecol}{rgb}{0.0,0.0,0.0};
  \pgfsetstrokecolor{strokecol}
  ...
  % Edge: w_{12} -> w_{27}
  \pgfsetcolor{black}
  \draw [->] [dashed] (406.13bp,586.6bp) .. controls (418.82bp,595.9bp) and (437.61bp,605.73bp)  .. (452.0bp,596.52bp) .. controls (482.41bp,577.06bp) and (495.94bp,535.64bp)  .. (503.67bp,497.69bp);
  \definecolor{strokecol}{rgb}{0.0,0.0,0.0};
  \pgfsetstrokecolor{strokecol}
  ...
  % Edge: w_{20} -> w_{47}
  \pgfsetcolor{black}
  \draw [->] [dashed] (402.93bp,169.0bp) .. controls (422.8bp,195.31bp) and (464.96bp,251.17bp)  .. (494.93bp,290.86bp);
  \definecolor{strokecol}{rgb}{0.0,0.0,0.0};
  \pgfsetstrokecolor{strokecol}
